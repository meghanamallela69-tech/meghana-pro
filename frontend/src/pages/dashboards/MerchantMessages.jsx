  ...
  return (
    <MerchantLayout>
      <div style={{ height: "calc(100vh - 80px)", display: "flex", background: "#f0f2f5", borderRadius: 12, overflow: "hidden", boxShadow: "0 2px 16px rgba(0,0,0,0.08)" }}>
        ...
        {/* ── Left: Chat List ── */}
        <div className="chat-list-panel" style={{ width: 320, flexShrink: 0, display: "flex", flexDirection: "column", background: "#fff", borderRight: "1px solid #e5e7eb" }}>
          ...
          <div style={{ flex: 1, overflowY: "auto" }}>
            {filteredChats.length === 0 ? (
              <div style={{ padding: 24, textAlign: "center", color: "#9ca3af", fontSize: 14 }}>
                <p>No chats yet</p>
                <p style={{ marginTop: 6, fontSize: 12 }}>Customer messages will appear here</p>
              </div>
        ...
        {/* ── Right: Conversation ── */}
        <div className="chat-conversation-panel" style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          {selectedChat ? (
            <>
              {/* Header */}
              ...
              <div style={{ flex: 1, overflowY: "auto", padding: "16px 12px", background: "#f8fafc", display: "flex", flexDirection: "column", gap: 4 }}
                ...
                {loading ? (
                  ...
                  <div style={{ textAlign: "center", color: "#6b7280", paddingTop: 40 }}>
                    <p>No messages yet</p>
                    <p style={{ fontSize: 13, marginTop: 6 }}>Start the conversation!</p>
                  </div>
